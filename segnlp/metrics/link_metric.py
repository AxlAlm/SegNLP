...
#segnlp
from segnlp.utils import one_hots

def link_metric(targets:np.ndarray, preds:np.ndarray, lengths):
...
def token_link_metric(targets:np.ndarray, preds:np.ndarray, lengths):
